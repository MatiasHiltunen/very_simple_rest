...
#[proc_macro_derive(RestApi, attributes(rest_api, require_role))]
    ...
    let expanded = quote! {
        mod #module_ident {
            ...
            impl #struct_name {
                ...
                async fn get_all(db: web::Data<AnyPool>) -> impl Responder {
                ...
                async fn get_one(path: web::Path<i64>, db: web::Data<AnyPool>) -> impl Responder {
                ...
                async fn create(item: web::Json<Self>, db: web::Data<AnyPool>) -> impl Responder {
                ...
                async fn update(path: web::Path<i64>, item: web::Json<Self>, db: web::Data<AnyPool>) -> impl Responder {
                ...
                async fn delete(path: web::Path<i64>, db: web::Data<AnyPool>) -> impl Responder {
