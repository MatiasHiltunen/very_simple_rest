...
impl AuthDbBackend {
    ...
    fn auth_claim_column_sql(self, column_name: &str, ty: AuthClaimType) -> String {
        ...
        let sql = match ty {
            ...
            AuthClaimType::Bool => "BOOLEAN NOT NULL DEFAULT FALSE".to_owned(),
        };
        format!("{quoted} {sql}")
    }
...
mod tests {
    use super::{
        ...
        AuthSettings, LoginInput, auth_claim_migration_sql, auth_management_migration_sql, auth_migration_sql,
