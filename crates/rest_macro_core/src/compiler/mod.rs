...
pub use model::{
    ...
    RoleRequirements, RowPolicies, ServiceSpec, StaticCacheProfile, StaticMode, StaticMountSpec,
    StructuredScalarKind, TsClientConfig, default_service_database_url, infer_sql_type,
    is_date_type, is_datetime_type, is_decimal_type, is_enum_field, is_json_array_type,
    ...
    read_requires_auth, structured_scalar_kind, supports_declared_index, supports_exact_filters,
