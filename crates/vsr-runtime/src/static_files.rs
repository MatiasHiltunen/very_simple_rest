//! Actix static-file adapter, including mount resolution, SPA fallback,
//! precompressed assets and cache headers.
...
pub use crate::static_config::{StaticCacheProfile, StaticMode, StaticMount};

/// Register static mounts with the default runtime settings.
...
/// Register static mounts with explicit compression settings.
