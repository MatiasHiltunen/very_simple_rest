    ...
    push_section(
        ...
        &[
            ...
            row(
                "resources[].list",
                "Map",
                "`count_endpoint = true`; no custom limit caps or `__in` filters",
                "No",
                "See List Settings",
                "Controls generated list endpoint defaults, hard caps, count endpoint generation, and opt-in multi-value filters.",
            ),
            row(
                "resources[].api",
                "Map",
    ...
    push_section(
        ...
        &[
            row(
                ...
                "No",
                "Role name",
                "When set, reads require the named role. `\"admin\"` also passes this gate.",
            ),
            row(
                ...
                "No",
                "Role name",
                "Write-role compatibility with the original shorthand is preserved. `\"admin\"` also passes this gate.",
            ),
            row(
                ...
                "No",
                "Role name",
                "When set, updates require the named role. `\"admin\"` also passes this gate.",
            ),
            row(
                ...
                "No",
                "Role name",
                "When set, deletes require the named role. `\"admin\"` also passes this gate.",
            ),
        ],
    );
    ...
    push_section(
        ...
        &[
            ...
            row(
                ...
                "[]",
                "No",
                "Exposed exact-filter field names",
                "Enables `filter_<field>__in=...` for the listed API-exposed storage fields. Each field must already support exact filters. Values are comma-separated and use the same coercion rules as `filter_<field>`.",
            ),
            row(
                "resources[].list.count_endpoint",
                "Bool",
                "true",
                "No",
                "true, false",
                "When true, generates `GET /api/<resource>/count`, returning `{ \"count\": N }` with the same filter and read-policy semantics as the list endpoint.",
            ),
        ],
    );
...
legacy flat assignment list and an object form with `assign` plus `require`.",
        &[
            row(
                ...
                "No",
                "true, false",
                "When true, users whose JWT roles include the literal string `\"admin\"` bypass the configured row-level policies.",
            ),
            row(
    ...
    push_section(
        ...
        &[
            row(
                "security.requests",
                "Map",
                "No custom extractor or query limits",
                "No",
                "See Request Security",
                "Controls JSON body size limits and the maximum number of values accepted by `filter_<field>__in`.",
            ),
            row(
                "security.cors",
                "Map",
    ...
    push_section(
        ...
        &[
            ...
            row(
                ...
                "No",
                "Positive integer",
                "Caps the number of comma-separated values accepted by each `filter_<field>__in` query parameter. Must be greater than 0 when provided.",
            ),
        ],
    );
